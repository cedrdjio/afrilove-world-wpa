...
/**
 * Filtres de recherche avancée — port de `searchFiltersStore` (mobile). État en
 * mémoire du constructeur de filtres ; les libellés d'options sont fixes (comme
 * sur mobile). L'application effective des filtres à la découverte relève du
 * Jalon 8 (le bouton « Rechercher » ouvre la découverte, à l'identique du mobile).
 */
