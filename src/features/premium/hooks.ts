...
import type { CheckoutInput } from "./payments";
...
export function usePurchasePlan() {
  ...
  return useMutation({
    ...
    onSuccess: (result) => {
      // Seul un paiement réglé change les droits ; annulé/en attente n'y touche
      // pas. Le premium débloque limites et liste des likers partout d'un coup.
