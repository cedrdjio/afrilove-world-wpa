...
/** Centre de notifications in-app — port de `notificationsService` (mobile). */
...
export function subscribeToNotifications(
  ...
  // l'écran récupérait la même instance de canal déjà abonnée, et l'ajout d'un
  // callback `postgres_changes` après `subscribe()` faisait planter le client
  // Realtime (« cannot add postgres_changes callbacks after subscribe() »).
