/**
 * Modèle « Profil » normalisé (camelCase) — port de `modules/profile/types`.
 * Distinct de la ligne brute `profiles` exposée par l'AuthProvider (utilisée
 * par les gardes) : ici on agrège les relations (photos, intérêts, langues)
 * pour les écrans profil/édition/vue publique.
 */
